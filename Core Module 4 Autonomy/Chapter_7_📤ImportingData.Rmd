...
✅ In the knitted notebook output, look directly under the `getwd()` and `list.files()` ub the console output. Confirm that the folder path matches where you saved `chapter7_practice.Rmd`. Then check whether the file list includes the notebook file itself.
