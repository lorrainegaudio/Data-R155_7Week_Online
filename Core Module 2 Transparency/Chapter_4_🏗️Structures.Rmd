...
🗣 Memo (outside of the code chunk): Explain how named vectors help make values easier to understand.
...
🎯 Use negative indexing to remove the 1st and 5th values from the `quiz_scores` vector.
...
🗣 Explain what negative indexing does in R. 
...
🗣 Explain what `TRUE` and `FALSE` mean in the `meets_goal` vector.
...
🗣 Memo: Explain which values were kept and why.
...
🎯 In one to two sentences, explain how the logical mask controls which values are kept.
