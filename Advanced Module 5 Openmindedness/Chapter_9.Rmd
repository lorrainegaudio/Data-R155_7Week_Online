...
9. Practice [local changes](#local-changes) and the full [pull, edit, commit, and push](#pull-edit-commit-and-push) workflow.
...
![Figure 5. git --version output examples](git_not_installed_error.png)
...
📸 Screenshot showing the GitHub Settings sidebar with SSH and GPG keys highlighted.
...
📸 Screenshot of the New SSH key form before clicking Add SSH key. Use a fake key or blur/crop the key box if needed.

📸 Screenshot after the key appears in your GitHub SSH keys list.
...
📸 Screenshot of the successful terminal message.
...
📸 Screenshot showing the green New button.
...
📸 Screenshot showing the finished repository page with README.md.

---

Your repository now exists online on GitHub. Let's get it onto your computer.

# Copy the SSH Repository Link {#copy-ssh-repo-link}
...
📸 Screenshot of the Code menu with SSH selected.
...
💡 Tip: If you see a message about authentication or permission denied, your SSH setup may need help. Use the support option instead of changing random settings.
...
📸 Screenshot suggestion: Take a screenshot showing the updated README on GitHub.
...
## Pull, edit, commit, and Push {#pull-edit-commit-and-push}
...
## Data Privacy and Organization {#data-privacy-and-organization}
