...
This activity may feel picky because the steps must happen in order. That is normal. GitHub setup is not difficult because any one step is impossible. It is difficult because skipping one small setup step can break the whole workflow.
...
🗣 Your computer has the full working project folder. GitHub only shows the files that Git is tracking and that you push online.
